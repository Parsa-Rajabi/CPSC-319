...
→ [More details](projects/aunt-leahs-place.md)
...
→ [More details](projects/surrey-food-bank.md)
...
→ [More details](projects/benevity.md)
...
→ [More details](projects/open-webui.md)
